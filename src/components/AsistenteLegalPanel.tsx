  ...
  const sortedPendingItems = useMemo(() => {
    ...
    return uniquePending.sort((a, b) => {
      ...
      if (!aEmitted && !bEmitted) {
        // Prioritize re-entered operations (observación levantada) at the top of the pending queue
                ...
                (() => {
                  ...
                  return (
                    <div className="space-y-3">
                      ...
                      {/* Prompt to lift observation if currently observed (Image 1 style: button stays completely inside) */}
                      {isCurrentObserved && currentSelected && (
                        <div className="p-4 bg-emerald-50/90 border border-emerald-300 rounded-2xl space-y-3 overflow-hidden">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            <div className="flex items-start gap-2.5 text-emerald-950 flex-1 min-w-0">
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="text-[11px] text-emerald-800 leading-snug mt-0.5">
                                  ¿El asesor o área subsanó la observación? Puedes marcar que se levantó para reanudar el contador de atención legal.
                                </p>
                              </div>
                            </div>
                            <button
                            ...
                            >
                              {isLiftingCurrent ? "Cerrar" : "Levantar Observación"}
                            </button>
                          </div>
                          ...
                          {isLiftingCurrent && (
                            <div className="pt-2 border-t border-emerald-200/60 space-y-2 animate-fadeIn">
                              <textarea
                                ...
                                rows={2}
                                className="w-full text-xs p-2 bg-white border border-emerald-300 rounded-xl outline-none focus:ring-1 focus:ring-emerald-500 text-slate-800"
                              />
                              <button
                                type="button"
