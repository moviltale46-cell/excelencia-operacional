...
import { AppSettings, OperationRecord, UserAccount, UserRole, ProjectConfig, TeamConfig, StatusHistoryEntry, WorkingScheduleConfig, DEFAULT_WORKING_SCHEDULE, ObservationReasonConfig, STANDARD_OBSERVATIONS } from "../types";
