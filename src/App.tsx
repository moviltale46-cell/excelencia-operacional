...
import { normalizeText } from "./utils/dateUtils";
...
export default function App() {
  ...
  const visibleSidebarRecords = records.filter(r => {
    ...
    // Jefe de Ventas: only their assigned projects
    if (currentUser.role === "Jefe de Ventas") {
      ...
      const normProj = normalizeText(r.proyecto);
      return userProjects.includes(normProj);
    }
                  ...
                  <table className="w-full text-left border-collapse text-[10px]">
                    ...
                    <tbody className="divide-y divide-blue-50">
                      ...
                      {visibleSidebarRecords.length === 0 && (
                        <tr>
                          <td colSpan={4} className="p-4 text-center text-slate-400 italic">No hay filas en la base de datos para tus proyectos.</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
